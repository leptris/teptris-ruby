# The API-surface round-trip both gem lanes assert: load, datetime
# mapping, dump, load-what-you-dumped. Shared by gem_smoke.rb
# (published gem) and gem_verify.rb (pre-publish local gem).
require "teptris"
